...
> Cookie expires after 1 year - refresh only when needed!  
...
const lyrics3 = await s.getLyrics("4iV5W9uYEdYUVa79Axb7Rh");
if (lyrics3 === null) {
...
## 📜 License  
MIT License 📄 - See [LICENSE](https://github.com/lkekana/spotify-lyrics-ts/blob/main/LICENSE) for details  
